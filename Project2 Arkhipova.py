...
if answer1 == 'да':
    ...
    if answer2 == 'да':
        ...
        if answer3 == 'да':
            ...
            answer3 = str(input())
            if answer3 == 'да':
                print('Это конус, введите его радиус и апофему')
                r, a = map(int, input().split())
                s = math.pi * r * (a + r)
                print('Площадь равна', s)
            else:
                print('Это цилиндр, введите его радиус и высоту')
        ...
        if answer3 == 'да':
            ...
            answer4 = str(input())
            if answer4 == 'да':
                print('Это параллелепипед, введите его длину, ширину и высоту')
                a, b, c = map(int, input().split())
                s = 2 * (a * b + b * c + a * c)
                print('Площадь равна', s)
            else:
                print('Это пирамида, введите ее периметр основания и апофему')
